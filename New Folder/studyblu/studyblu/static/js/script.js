...
//   fetch('/unread_notif/').then(response => response.json()).then(data => {
...
//   .catch(error => console.error ('erro fetching notification', error));

// }
// document.addEventListener('DOMContentLoaded', updateNotification);

// document.getElementById('notification').addEventListener('click', function(){
//   fetch('/mark_read/', {method:'POST'})
...
//     }
//     else {
//       console.error('error markin notification', data.error);
//     }
//   })
//   .catch(error => console.error('error making notification', error));
// });
...
// Scroll to Bottom
const conversationThread = document.querySelector(".room__box scroll");
