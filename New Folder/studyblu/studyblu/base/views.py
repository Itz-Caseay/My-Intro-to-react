...
def unread(request):
    ...
    return render(request, 'base/feed_components.html', context)
...
def home(request,pk):
          ...
          if request.GET.get('join') is not None:
            ...
            messages.info(request, 'you joined this room')
              ...
              if request.user == room.host: 
                messages.info(request, 'You lest this room')
    ...
    def unread_view(request, pk):
        ...
        return render(request, 'base/feed_componets.html', {'unread_m':unread_m})        
...
#         return redirect('home', pk=join.id)
